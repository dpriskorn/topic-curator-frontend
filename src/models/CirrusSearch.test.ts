...
describe("CirrusSearch", () => {
    ...
    beforeEach(() => {
        ...
        cirrusSearch = new CirrusSearch(topic, term, subgraph);
    });

    it("should construct correctly", () => {
        expect(cirrusSearch.topic).toBe(topic);
    ...
    it("should return correct cirrussearchTotal", async () => {
        ...
        const total = await cirrusSearch.cirrussearchTotal();
    ...
    it("should return correct cirrussearchUrl", () => {
        ...
        expect(cirrusSearch.cirrussearchUrl).toBe(expectedUrl);
    });
});
